        ...
        <div className="container mx-auto px-6 max-w-2xl">
          ...
          >
            ...
            <p className="text-xs text-brand-dark/40 text-center font-brand pt-2 leading-relaxed">
              FormSubmit will open in a new tab to complete the submission. Your message and email address are received to respond to your inquiry. Not stored or shared with third parties.
            </p>
...
/* ===== RESEND IMPLEMENTATION (future use) =====
